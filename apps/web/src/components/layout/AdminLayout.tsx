...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-64 flex-col bg-gray-900 text-white shadow-xl transition-transform duration-200 lg:relative lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center gap-2 px-5 py-5 border-b border-white/10">
          ...
          <div>
            <p className="font-bold text-sm leading-tight">WA Atendimento</p>
          ...
          {me && (
            <div className="flex items-center gap-2 px-3 py-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="truncate text-xs font-medium text-white">{me.name}</p>
                <p className="truncate text-[10px] text-gray-400">{me.email}</p>
              </div>
              <button
                onClick={logout}
                title="Sair"
